...
#ifndef LEOSIMULATORTEST_SWIFT_H
#define LEOSIMULATORTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="leoSimulatorTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16leoSimulatorTest11AppDelegate")
...
SWIFT_CLASS("_TtC16leoSimulatorTest15GeigerLEService")
@interface GeigerLEService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface GeigerLEService (SWIFT_EXTENSION(leoSimulatorTest)) <CBPeripheralManagerDelegate>
...
SWIFT_CLASS("_TtC16leoSimulatorTest13SceneDelegate")
...
SWIFT_CLASS("_TtC16leoSimulatorTest14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)onStartClick:(id _Nonnull)sender;
- (IBAction)onClickDevice:(id _Nonnull)sender;
- (IBAction)onClickUpdate:(id _Nonnull)sender;
- (IBAction)onStopClick:(id _Nonnull)sender;
